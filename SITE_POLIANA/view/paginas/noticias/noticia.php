...
<div class="panel-heading"><h1><?php echo $noticia->titulo ?></h1></div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="coments">
            ...
            <p class="coment-user">Percebemos, cada vez mais, que a adoção de políticas descentralizadoras deve passar por modificações independentemente dos paradigmas corporativos.</p>
        </div>
